...
INSERT INTO partner(id, name, description, time_added)
  VALUES(10001, 'Dangote', 'Still dey find money', CURRENT_TIMESTAMP);
...
INSERT INTO partner_user(id, partner_id, name, email, username, password, time_added)
  VALUES(10001, 10001, 'Dangote''s Assistant', 'dangote@dangote.com', 'dangote_assistant', 'password', CURRENT_TIMESTAMP);
